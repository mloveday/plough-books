...
class CashUp
{
    ...
    public function serialise() {
        return (object) [
            ...
            'discountStaffDry' => $this->discount_staff_dry,
            'discountCustomersWet' => $this->discount_customers_wet,
            'discountCustomersDry' => $this->discount_customers_dry,
            'discountCustomersCoffee' => $this->discount_customers_coffee,
            'fwtWet' => $this->fwt_wet,
            ...
            'spendStaffPoints' => $this->spend_staff_points,
            'comoDiscountAsset' => $this->como_discount_asset,
