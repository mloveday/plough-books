  ...
  public render() {
    return (
      <div className="overview-rota-group">
        ...
        <div className="overview-stat"><RevenueCompare label="Revenue" showLabel={false} forecast={this.props.dailyOverviews.forecastRevenue} actual={this.props.dailyOverviews.actualRevenue} /></div>
