...
export class CashUpEntityInputs extends CashUpEntityAbstract<string, undefined, undefined, undefined> implements CashUpEntityInputType {
  ...
  public with(obj: CashUpEntityUpdateType): CashUpEntityInputs {
    return new CashUpEntityInputs(
      ...
      obj.chargeToAccount !== undefined ? obj.chargeToAccount : this.chargeToAccount,
      obj.depositRedeemed !== undefined ? obj.depositRedeemed : this.depositRedeemed,
      obj.compsWet !== undefined ? obj.compsWet : this.compsWet,
      obj.dStaffDry !== undefined ? obj.dStaffDry : this.dStaffDry,
      obj.dCustomersWet !== undefined ? obj.dCustomersWet : this.dCustomersWet,
      obj.dCustomersDry !== undefined ? obj.dCustomersDry : this.dCustomersDry,
      obj.dCustomersCoffee !== undefined ? obj.dCustomersCoffee : this.dCustomersCoffee,
      obj.fwtWet !== undefined ? obj.fwtWet : this.fwtWet,
      obj.comoInDrawer !== undefined ? obj.comoInDrawer : this.comoInDrawer,
      obj.amexTots !== undefined ? obj.amexTots : this.amexTots,
      obj.visaMcTots !== undefined ? obj.visaMcTots : this.visaMcTots,
      obj.spendStaffPts !== undefined ? obj.spendStaffPts : this.spendStaffPts,
      obj.comoDiscAsset !== undefined ? obj.comoDiscAsset : this.comoDiscAsset,
      obj.takeDry !== undefined ? obj.takeDry : this.takeDry,
      obj.takeCoffee !== undefined ? obj.takeCoffee : this.takeCoffee,
      obj.takeGiftCard !== undefined ? obj.takeGiftCard : this.takeGiftCard,
      obj.takeDepositPaid !== undefined ? obj.takeDepositPaid : this.takeDepositPaid,
      obj.paidOutAmount !== undefined ? obj.paidOutAmount : this.paidOutAmount,
      obj.paidOutTo !== undefined ? obj.paidOutTo : this.paidOutTo,
      obj.banked !== undefined ? obj.banked : this.banked,
